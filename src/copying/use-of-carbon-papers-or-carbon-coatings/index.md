...
<span class="small-caps">The</span> method to be adopted for making such copies of the form as are required in use must be carefully considered since it may substantially affect certain aspects of its design. The methods principally used are described below.
...
5. One-time carbons, either as separate sheets, or as carbonised forms; these are used for handwriting and for typewriting etc.
...
<span class="small-caps">Coloured carbons</span> are obtainable as follows, but the colours shown in brackets are not normally stocked by H.M. Stationery Office:
...
<span class="small-caps">Pencil carbons</span> are designed for use with a fairly hard pencil, and it is advisable to use a backing sheet of card or metal if more than one carbon copy is to be taken.

<span class="small-caps">Two-sided pencil carbons</span> are designed for use with manifold books or sets— when the top or second copy is on tissue or translucent paper, the carbon entry on the back of the tissue paper being read through this paper; thus one sheet of two-sided carbon paper can be used to produce three copies (a top copy, the tissue copy, and a copy underneath the two-sided carbon). In another application of this type of carbon the impression on both sides of a sheet makes alteration or falsification more difficult.
Two-sided carbon paper is about 25% more expensive than one-sided carbon and the latter is preferable unless the copying methods offer a compensating saving by the use of two-sided carbon and tissue paper.

<span class="small-caps">Pen carbons</span> are more sensitive than pencil carbons, and a backing sheet or plate is generally necessary. Sensitive carbons reproduce pressure marks upon the top copy with fingers as dirty marks on the carbon copies, but such blemishes can be avoided.
...
<span class="small-caps">Typewriter carbons</span> are stocked by H.M. Stationery Office, in two weights but only one colour (black), as follows:
...
<span class="small-caps">In bands</span> in which the carbon coating is flowed on to the paper in continuous bands along the whole length of the reel of paper. Bands can be varied in width and position, the reel being cut subsequently into separate sheets on which the bands of carbon run from edge to edge. Band carbonised forms are usually printed after carbonising.

<span class="small-caps">In patches</span>: with this process the carbon coating is ‘printed’ from special blocks of the required size or shape using liquid carbon coating instead of printer’s ink. The face sides of the forms are usually printed prior to carbonising.
...
2. Some recipients of forms do not like carbon coating. The carbon coating may rub off and soil the hands, or adjacent papers in files.
3. The carbon coating tends to soak through the paper, darkening the writing surface, and reducing the legibility of pencil entries on the carbon-coated form.
...
The purpose of each copy is shown at the top, and a corner is numbered. Apart from this, each copy has identical printing in black ink on different coloured paper.
The set is prepared by the Consignor before sending his surplus goods to a Clearing Depot for reissue or sale etc.
Copy No. 6 is kept for control purposes by the Consignor who sends the other five copies to the Clearing Depot.
Copy No. 1 becomes a posting medium after use by the Storekeeper and the
Assistant Superintendent of the depot,
Copy No. 2 is kept by the Storekeeper.
Copies No. 3 and 4 are used as depot control documents before use as a Consignor’s Receipt and Accounts Division copy.
Copy No. 5 serves as an Advice to the Consignor that the depot can accept the goods and as an advice to the Removal Contractor. The introduction of this form eliminated the copying work involved in maintaining several separate records, and also improved control by using original documents to serve different purposes at various stages without creating fresh records
</figcaption>
</figure>
...
![Manilla form holder.
Register of Cheques issued on, blank field.
...
Reconciliation.
CARBON SHEET on top.
No. 2(superscirpt 5c)(subscript c) 039624.
Barclay’s Bank Limited.
London, blank field.
Pay the sum of, blank field, to, blank field.
Blank field, Steward.
Blank field, Governor.]({{ page.url }}4.jpg)

<figcaption>
For ‘two-in-one’ writing operations on forms of different size, simple and inexpensive devices which do not require punched holes can be used to keep two forms in registration.
In this example a cheque and cheque register are prepared in one operation with ordinary carbon paper, the sheets being held in registration by means of a manilla backing card, the left edge of which is folded to make a flap over the left-hand margins of the two forms; printed lines on the flap and in the middle of the cheque register enable each cheque to be positioned correctly and easily on the next line of entry on the cheque register
</figcaption>
</figure>

<figure>

![Form with title INCOME TAX—Return of Payment for Services or In respect of a Copyright.
For Official use, blank field.
Payer’s Name: T.W. GILL Agents.
London WC1.
GILL Ref. No., blank field.
Payee’s Name and Last Known Address:, blank field.
Year ended, blank field.
“Nature of Service” Code.
1-4 & 6 Musician,
5 Variety Artist,
7 Drama Artist,
8 Choral Artist,
...
10 Miscellaneous,
\- Copyright.
Nature of Service (See Code above):, blank field.
Note: Any query on any of these entries should be addressed to London Provincial District and not to GILL.
...
Date., blank field.
No. 46P
Form repeats again.]({{ page.url }}5.jpg)

<figcaption>
Semi-continuous forms can be supplied in perforated strips (4 forms per sheet) to facilitate preparation, by typewriter, of returns of certain payments. After separation the slips are used as unit documents for assembling particulars of the earnings of the individual recipients. Similar type forms can be produced as continuous stationery with sprocket holes for use in accounting machines
</figcaption>
</figure>

<figure>

![Form with title CARBONISED LIST and empty rows.
On top of form with title RECEIPT OR VOUCHER.
The top form has a printed line on voucher to facilitate alignment.]({{ page.url }}6.jpg)

<figcaption>
A deep entry space on the under copy and a thick printed line facilitate registration for carbon copying
</figcaption>
</figure>

<figure>

![A person aligning forms with holes on the left side into  apeg board.]({{ page.url }}7.jpg)

<figcaption>
A peg board simplifies the handling and positioning of forms for a ‘three-in-one’ writing operation with carbon paper, when it is necessary for three forms of different size and shape to be kept in accurate registration
</figcaption>
</figure>
