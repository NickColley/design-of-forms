...
| 25 | Make space appear equal between words | ![Forward slash]({{ page.url }}forwards-slash.jpg) between words | ![ ]({{ page.url }}eq.jpg) ![ ]({{ page.url }}pound.jpg) |
| 26 | Reduce space between words<sup>*</sup> | ![Forward slash]({{ page.url }}forwards-slash.jpg) between words | ![ ]({{ page.url }}less.jpg) ![ ]({{ page.url }}pound.jpg) |
